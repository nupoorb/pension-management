...
public class PensionerDetailController {
	...
	public PensionerDetail findById(@RequestHeader(name="Authorization") String header ,@PathVariable("aadharnumber") long aadharnumber) throws InvalidTokenException , NumberFormatException, IOException, ParseException, NotFoundException {
